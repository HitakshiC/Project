...
let ParentController = class ParentController {
    constructor() {
        //Api 
        this.searchslotsBookings = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            let result1 = yield this.ParentService.findcount(" count(*) AS search_count ", " evbooking", where);
            ...
            try {
                let result = yield this.ParentService.findfieldpagi(field, " evbooking", where, per_page, startindex);
        ...
        this.MonthCount = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            //let id = req.params.id;
            ...
            try {
                let result1 = yield this.ParentService.findcount(" count(*) AS scount1 ", " evbooking", jul);
                let result2 = yield this.ParentService.findcount(" count(*) AS scount2 ", " evbooking", aug);
                let result3 = yield this.ParentService.findcount(" count(*) AS scount3 ", " evbooking", sept);
                let result4 = yield this.ParentService.findcount(" count(*) AS scount4 ", " evbooking", oct);
                let result5 = yield this.ParentService.findcount(" count(*) AS scount5 ", " evbooking", nov);
                let result6 = yield this.ParentService.findcount(" count(*) AS scount6 ", " evbooking", dec);
        ...
        this.updateisactive = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            ...
            console.log("set: " + set);
            try {
                let id = yield this.ParentService.Update_data(" charge_station", set, where);
                if (id && id.rowCount > 0) {
                    res
                        .status(200)
        ...
        this.addfeedback = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let result = yield this.ParentService.Insert_data(" feedback", col, val, ' fid');
                if (result.rowCount > 0) {
                    var top = result.rows;
        ...
        this.updateStatus1 = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            ...
            console.log("set: " + set);
            try {
                let id = yield this.ParentService.Update_data(" evbooking", set, where);
                console.log(id);
                if (id && id.rowCount > 0) {
                    res
                        .status(200)
        ...
        this.updateSlot = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
        ...
        this.deleteBooking = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            let where = ` evb_id= ${id}`;
            try {
                let id = yield this.ParentService.delete_data(" evbooking", where);
                console.log(id);
                if (id && id.rowCount > 0) {
                    res
                        .status(200)
        ...
        this.viewcarBooking = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            //let id = req.params.id;
            ...
            let result1 = yield this.ParentService.findcount(" count(*) AS search_count ", " rentbooking ", where);
            if (result1.rowCount > 0) {
                var count = result1.rows[0].search_count;
                console.log("Count" + result1.rows[0].search_count);
                // res.json({ status: "1", data: count });
            ...
            const startindex = (page - 1) * per_page;
            try {
                let result = yield this.ParentService.findfieldpagi(field, "rentbooking ", where, per_page, startindex);
                if (result.rowCount > 0) {
                    var top = result.rows;
                    var perpagecnt = result.rowCount;
                    console.log("Data", result.rowCount);
        ...
        this.manageslotBooking = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            //let id = req.params.id;
        ...
        this.manageslotsBookings = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            //let id = req.params.id;
        ...
        this.allslotsBookings = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            //let id = req.params.id;
        ...
        this.allcarsBookings = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            //let id = req.params.id;
        ...
        this.viewSlotBooking = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let id = req.params.id;
            ...
            let where = "  where uid=" + id;
            try {
                let result = yield this.ParentService.findfield(field, "evbooking", where);
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.view_transactionbyid = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let id = req.params.id;
            ...
            try {
                let result = yield this.ParentService.findfield(field, "transaction", where);
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.addstation = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            ...
            try {
                let result = yield this.ParentService.Insert_data("charge_station", col, val, 'cs_id');
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.bookingcar = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            ...
            try {
                let result = yield this.ParentService.Insert_data("rentbooking", col, val, 'brid');
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.bookingStation = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            ...
            try {
                let result = yield this.ParentService.Insert_data("evbooking", col, val, 'evb_id');
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.adduser = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            const salt = encryptionUtil_1.EncryptionUtil.generateSalt(10);
            let hashedPassword = encryptionUtil_1.EncryptionUtil.encrypt(req.body.password, salt);
            ...
            try {
                let result = yield this.ParentService.Insert_data("user_tbl", col, val, 'uid');
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.login_station = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            ...
            try {
                let result = yield this.ParentService.findfield(field, "charge_station", where);
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.login_admin = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let email = req.body.email;
            ...
            try {
                let result = yield this.ParentService.findfield(field, "superadmin", where);
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.login_user = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (result.rowCount > 0) {
                    var top = result.rows;
                    const isPasswordMatch = encryptionUtil_1.EncryptionUtil.compare(password, result.rows[0].password);
                    if (isPasswordMatch) {
        ...
        this.transaction = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let fulldate = commonUtils_1.CommonUtils.postgressDateFormat();
            ...
            try {
                let result = yield this.ParentService.Insert_data("transaction", col, val, 'tid');
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.transaction1 = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let fulldate = commonUtils_1.CommonUtils.postgressDateFormat();
            ...
            try {
                let id = yield this.ParentService.Update_data(" user_tbl", set, where);
                console.log(id);
                if (id.rowCount > 0) {
                    const col = "uid,evid,evname,date,action,uamt,amt";
        ...
        this.update_location = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
        ...
        this.addmoney = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
        ...
        this.updatemoney = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let user_id = req.body.user_id;
        ...
        this.view_stationbyid = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let id = req.params.id;
        ...
        this.view_userbyid = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let id = req.params.id;
        ...
        this.view_evcarsbyid = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let field = ' *';
            ...
            try {
                let result = yield this.ParentService.findfield(field, "evcars", where);
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.view_evcars = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let field = ' *';
        ...
        this.view_evstations = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let field = ' *';
        ...
        this.filter_evstations = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
        ...
        this.update_station = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let location = req.body.location;
        ...
        this.viewfeedback = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let id = req.params.id;
            ...
            let where = "  where evid=" + id;
            try {
                let result = yield this.ParentService.findfield(field, "feedback", where);
                if (result.rowCount > 0) {
                    var top = result.rows;
                    res.json({ status: "1", data: top });
                }
        ...
        this.viewfeedbacks = (req, res) => __awaiter(this, void 0, void 0, function* () {
            res.header("Access-Control-Allow-Origin", "*");
            res.header("Access-Control-Allow-Headers", "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With");
            res.header("Access-Control-Allow-Methods", "POST, GET, PUT, DELETE, OPTIONS");
            let field = ' *';
...
], ParentController.prototype, "ParentService", void 0);
